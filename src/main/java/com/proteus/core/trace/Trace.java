...
/*
	...
	public Trace(Collection<TraceObject> domEventCollection, Collection<TraceObject> functionCollection, Collection<TraceObject> timingCollection, Collection<TraceObject> xhrCollection) {
